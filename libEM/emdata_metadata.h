 ...
 * @return 2D multi-array format of the raw data.
 */
MArray2D get_2dview(unsigned int x0, unsigned int y0) const;
 ...
 * @return 3D multi-array format of the raw data.
 */
MArray3D get_3dview(unsigned int x0, unsigned int y0, unsigned int z0) const;
 ...
 * @return 2D multi-array format of the raw data.
 */
MCArray2D get_2dcview(unsigned int x0, unsigned int y0) const;
 ...
 * @return 3D multi-array format of the raw data.
 */
MCArray3D get_3dcview(unsigned int x0, unsigned int y0, unsigned int z0) const;
